...
export function isExternalModule(importPath) {
...
export function validateImportPath(importPath, currentFile) {
    if (!importPath) {
...
export function resolveAndValidate(importPath, basePath) {
    try {
...
export function getImportType(importPath) {
