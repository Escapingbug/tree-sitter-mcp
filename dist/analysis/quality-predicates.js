 ...
 */
export function shouldCheckForUnnecessaryAbstraction(node, length) {
 ...
 */
export function createAbstractionFinding(node, length, usageCount) {
 ...
 */
export function getQualityThresholds(filePath) {
 ...
 */
export function isAnonymousFunction(node) {
    if (!node.name)
        return true; // No name = anonymous
 ...
 */
export function isSpecialFunction(node) {
...
//# sourceMappingURL=quality-predicates.js.map