 ...
 */
export function createConsoleOutput(data) {
 ...
 */
export function renderAnalysis(data, format = 'console') {
    if (format === 'json') {
        return {
            summary: {
 ...
 */
export function populateTemplateWithSections(template, data, sections = {}) {
    let result = template;
 ...
 */
export function buildQualitySection(metrics) {
    if (!metrics)
        return '';
 ...
 */
export function buildDeadcodeSection(metrics) {
    if (!metrics)
        return '';
 ...
 */
export function buildStructureSection(metrics) {
    if (!metrics)
        return '';
 ...
 */
export function buildCriticalIssuesSection(findings, count) {
    if (count === 0)
        return '';
 ...
 */
export function buildWarningsSection(findings, count) {
    if (count === 0)
        return '';
 ...
 */
export function buildSyntaxSection(syntaxMetrics) {
    if (!syntaxMetrics)
        return '';
 ...
 */
export function renderBuild(data, format = 'console') {
