 ...
 */
export function extractContent(content, options = {}) {
    const { maxLines, maxCharacters, highlightLine, contextBefore = 0, contextAfter = 0, showLineNumbers = false, truncationMessage = '...', } = options;
 ...
 */
export function extractNodeContent(node, options = {}) {
    if (!node.content) {
        return {
            content: '',
            truncated: false,
 ...
 */
export function getUsageContext(node, highlightLine, lines) {
