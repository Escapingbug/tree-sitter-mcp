 ...
 */
export function isInComment(content, index) {
 ...
 */
export function isInTypeDefinition(content, index) {
    const beforeIndex = content.substring(0, index);
 ...
 */
export function isInSuspiciousContext(content, index) {
    const beforeIndex = content.substring(0, index);
 ...
 */
export function isCommonString(str) {
...
//# sourceMappingURL=string-analysis.js.map